...
ALTER TABLE "post" ADD COLUMN IF NOT EXISTS content_format smallint NOT NULL DEFAULT 0;
ALTER TABLE "post" DROP CONSTRAINT IF EXISTS post_content_format_check;
ALTER TABLE "post" ADD CONSTRAINT post_content_format_check CHECK (content_format IN (0, 1));
