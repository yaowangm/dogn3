...
| Update post content | Denied | Own posts only | Own posts only | Any post | Require same-origin-fetch header; prohibit author/tree changes through the editor; maintain affected derived counts and invalidate portal cache. |
