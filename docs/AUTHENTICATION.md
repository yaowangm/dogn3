...
| Update post content | Denied | Own root posts only | Own root posts only | Any post | Require same-origin-fetch header; prohibit author/tree/link/image changes through the editor; keep non-root post type normal; maintain affected derived counts and invalidate portal cache. |
